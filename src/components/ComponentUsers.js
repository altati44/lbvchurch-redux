...
function ComponentUsers(props) {
    ...
    return (
        ...
        >
            <Grid item xs={props.showDetails ? 8 : 12} style={{ align: 'center' }} >
                ...
                <DataTable
                    ...
                    httpToServer="http://localhost:5000/api/users/"//posible no necesario pq no se necesite una primera carga
                />
            </Grid>
            <Grid item xs={4} id="card-details" border={1} style={{ align: 'center' }}> {/**Panel derecho con los detalles del amigo ......pasarlo aparte y dejar table sola en este*/}
...
export default connect(mapStateToProps, mapDispatchToProps)(ComponentUsers);